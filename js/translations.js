...
const translations = {
  de: {
    ...
    "hero.subtitle":
      "Spezialisiert auf AI Agents und AI Security. Ich transformiere komplexe Probleme in elegante, sichere technische Lösungen. Schnelle Iteration, moderne Technologien, messbare Ergebnisse.",
    ...
    "services.subtitle":
      "Spezialisiert auf zukunftsweisende Technologien, die Ihr Unternehmen voranbringen",
    "services.ai.title": "AI Agents",
    "services.ai.description":
      "Von autonomen Agenten über automatisierte Workflows bis hin zu selbst gehosteten LLMs. Massgeschneiderte KI-Systeme mit voller Datensouveränität – Ihre KI, Ihre Infrastruktur, Ihre Kontrolle.",
    ...
    "about.description1":
      "Als Ihr IT-Consultant sehe ich meine Aufgabe darin, nicht nur technologische Lösungen zu liefern, sondern den Weg für das Kommende zu bereiten. Meine Arbeit ist getrieben von der Vision, durch KI und innovative Applikationen neue Möglichkeiten zu schaffen.",
    "about.description2":
    ...
    "about.description3":
      "Im Zeitalter der KI zählt Geschwindigkeit: Schnell iterieren, Ideen validieren und Ergebnisse liefern. Wer die neuen Technologien richtig einsetzt, erreicht in Wochen, was früher Monate dauerte.",
    "about.cta": "Zusammenarbeiten",
    "about.terminal.title": "Über Mich",
    "about.terminal.p1":
      "Als IT-Consultant und Entwickler verbinde ich tiefgreifendes technisches Know-how mit der Vision, innovative Lösungen zu schaffen.",
    ...
    "contact.description":
      "Bereit, Ihr nächstes Projekt zu diskutieren? Ich freue mich darauf, von Ihnen zu hören und gemeinsam innovative Wege zu gehen.",
    ...
    "blog.title": "Blog",
    "blog.subtitle":
      "Gedanken und Erkenntnisse zu KI, Entwicklung und Technologie",
    ...
    "bw.hero.sub":
      "Ich baue autonome KI-Agenten, die echte Arbeit erledigen – und breche sie, bevor Angreifer es tun. Von der Idee zur Produktion in Wochen.",
    "bw.hero.cta1": "WEBSITE GRATIS SCANNEN ▸",
    "bw.hero.cta2": "GESPRÄCH BUCHEN",
    "bw.hero.proof":
      "Vertrauen von Unternehmen wie <b>Coop</b>, <b>Charité BIH</b> &amp; 10+ Teams · <b>2. Platz</b> Prompt-Injection-Challenge",
    "bw.scan.kicker": "// GRATIS · AGENT-POTENZIAL-SCAN",
    "bw.scan.title":
      'Sieh, was ich für <span class="rip">dich</span> bauen würde — in 15 Sekunden.',
    "bw.scan.sub":
      "Gib deine Firmen-URL ein. Meine KI liest deine Website und zeigt dir genau, wo autonome Agenten deinem Team am meisten Zeit sparen. Keine Anmeldung.",
    "bw.scan.placeholder": "deine-firma.de",
    "bw.scan.run": "SCAN STARTEN ▸",
    "bw.scan.hint":
      "◆ Liest nur deine öffentliche Website · keine Anmeldung · dauert ~20s",
    ...
    "bw.scan.final.cached": "· Ergebnis aus dem Cache (kürzlich gescannt)",
    ...
    "bw.svc.1.desc":
      "Autonome Agenten, Workflows und selbst gehostete LLMs, die echte Arbeit erledigen — volle Datensouveränität. Ollama, CrewAI, LangChain, RAG.",
    "bw.svc.1.cta": "TERMIN BUCHEN ▸",
    "bw.svc.2.title": 'AI <span class="rip">Security</span>',
    "bw.svc.2.desc":
      "Red-Teaming und Hardening für KI-Systeme — von Prompt-Injection-Abwehr bis Cloud. 2. Platz bei einer Prompt-Injection-Challenge.",
    "bw.svc.2.cta": "TERMIN BUCHEN ▸",
    "bw.svc.3.title": 'Custom <span class="rip">Development</span>',
    "bw.svc.3.gate": "Auf Anfrage",
    "bw.svc.3.desc":
      "Selektiv — für Projekte, die technisch reizvoll sind und wirklich passen. Erzähl mir davon, dann sehen wir weiter. React Native, SvelteKit, Supabase, TypeScript.",
    ...
    "bw.breach.resultBody":
      "Jede Abwehr getestet und gebrochen. Die komplette Analyse gibt es im Blog.",
    ...
    "bw.contact.a.desc":
      "Agenten bauen oder härten? Schnapp dir einen Slot — wir klären es im Call.",
    ...
    "bw.contact.b.desc":
      "Selektiv, deshalb noch kein Kalender. Schreib mir zuerst kurz zum Projekt — worum es geht, warum es spannend ist. Wenn es passt, sprechen wir.",
    ...
    "bw.cta.sub":
      "Starte mit einem Gratis-Scan oder schildere mir einfach das Problem. Ich baue den Agenten und härte ihn.",
    "bw.cta.btn": "WEBSITE GRATIS SCANNEN ▸",
    "bw.foot.tagline":
      'w<span class="ai">AI</span>ser<span class="tld">.dev</span> · Nils Weiser',
    "bw.blog.kicker": "// FIELD NOTES VON DER ANDEREN SEITE",
    "bw.blog.title": 'Der <span class="rip">Blog</span>',
    "bw.blog.sub":
      "Notizen zu KI-Agenten, AI Security und den Maschinen, die lernen, sich ohne uns zu bewegen — roh aufgezeichnet, veröffentlicht, bevor die Spur verblasst.",
    "bw.blog.ctaTitle": 'Ein hartes<br><span class="rip">KI-Problem?</span>',
    "bw.blog.ctaSub":
      "Ob Agenten bauen oder brechen — wenn es interessant ist, will ich davon hören.",
    "bw.blog.ctaBtn": "PROJEKT STARTEN ▸",
    "bw.404.kicker": "// SIGNAL VERLOREN",
    "bw.404.title": "Diese Seite ging aus.",
    "bw.404.body":
      "Die Spur löste sich nicht auf — die gesuchte Seite existiert nicht, wurde verschoben oder war nie hier. Zurück zu etwas Echtem.",
  ...
  en: {
    ...
    "hero.title": "IT Consultant & AI Developer",
    "hero.subtitle":
      "Specialized in AI agents and AI security. I transform complex problems into elegant, secure technical solutions. Rapid iteration, modern technologies, measurable results.",
    ...
    "services.subtitle":
      "Specialized in forward-thinking technologies that drive your business forward",
    "services.ai.title": "AI Agents",
    "services.ai.description":
      "From autonomous agents to automated workflows and self-hosted LLMs. Custom AI systems with full data sovereignty – your AI, your infrastructure, your control.",
    "services.security.title": "AI Security",
    "services.security.description":
      "Security audits and hardening for AI systems and modern web infrastructure. From prompt injection defense to cloud security – so your AI solution doesn't become an attack surface. (2nd place in a prompt injection challenge.)",
    "services.custom.badge": "✦ Selected projects only",
    "services.custom.title": "Custom Development",
    "services.custom.description":
      "I now take on full-stack web and mobile development only selectively – for projects that are an especially strong fit.",
    "about.kicker": "Who I am",
    "about.title": "Vision & Drive",
    "about.description1":
      "As your IT consultant, I see my role not just in delivering technological solutions, but in paving the way for what's to come. My work is driven by the vision of creating new possibilities through AI and innovative applications.",
    "about.description2":
      "Transparency, collaborative partnership, and an unwavering commitment to quality are the cornerstones of my work, to achieve great things together.",
    "about.description3":
      "In the age of AI, speed matters: rapid iteration, fast validation, real results. Those who leverage new technologies correctly achieve in weeks what used to take months.",
    "about.cta": "Work together",
    "about.terminal.title": "About Me",
    "about.terminal.p1":
      "As an IT consultant and developer, I combine deep technical expertise with the vision to create innovative solutions.",
    ...
    "contact.description":
      "Ready to discuss your next project? I look forward to hearing from you and exploring innovative paths together.",
    ...
    "bw.hero.sub":
      "I build autonomous AI agents that do real work — and break them before attackers can. From idea to production in weeks.",
    "bw.hero.cta1": "SCAN MY SITE FREE ▸",
    "bw.hero.cta2": "BOOK A CALL",
    "bw.hero.proof":
      "Trusted by <b>Coop</b>, <b>Charité BIH</b> &amp; 10+ teams · <b>2nd place</b> prompt-injection challenge",
    "bw.scan.kicker": "// FREE · AGENT OPPORTUNITY SCAN",
    "bw.scan.title":
      'See what I\'d build for <span class="rip">you</span> — in 15 seconds.',
    "bw.scan.sub":
      "Drop your company URL. My AI reads your site and maps exactly where autonomous agents would save your team the most time. No signup.",
    "bw.scan.placeholder": "your-company.com",
    "bw.scan.run": "RUN SCAN ▸",
    "bw.scan.hint": "◆ Reads your public site only · no signup · takes ~20s",
    ...
    "bw.scan.final.cached": "· cached result (scanned recently)",
    "bw.scan.aria.scanning": "Scanning {domain}",
    "bw.svc.kicker": "// WHAT I DO",
    "bw.svc.title": "Three ways I move the needle.",
    "bw.svc.1.title": 'AI <span class="rip">Agents</span>',
    "bw.svc.1.desc":
      "Autonomous agents, workflows and self-hosted LLMs that do real work — full data sovereignty. Ollama, CrewAI, LangChain, RAG.",
    "bw.svc.1.cta": "BOOK A CALL ▸",
    "bw.svc.2.title": 'AI <span class="rip">Security</span>',
    "bw.svc.2.desc":
      "Red-teaming and hardening for AI systems — prompt-injection defense to cloud. 2nd place in a prompt-injection challenge.",
    "bw.svc.2.cta": "BOOK A CALL ▸",
    "bw.svc.3.title": 'Custom <span class="rip">Development</span>',
    "bw.svc.3.gate": "By invitation",
    "bw.svc.3.desc":
      "Selective — for projects that are technically interesting and a genuine fit. Tell me about it and we'll see. React Native, SvelteKit, Supabase, TypeScript.",
    ...
    "bw.breach.intro":
      "A hardened agent, poisoned in two messages — no jailbreak required. This is the failure mode I hunt.",
    ...
    "bw.breach.resultBody":
      "Every defense tested and broken. The full teardown lives on the blog.",
    "bw.feed.kicker": "// FIELD NOTES",
    ...
    "bw.contact.a.title": "AI Agents & AI Security",
    "bw.contact.a.desc":
      "Building agents or hardening them? Grab a slot — we'll scope it on a call.",
    "bw.contact.a.for": "For <b>AI Agents</b> & <b>AI Security</b>",
    "bw.contact.a.cta": "BOOK A CALL ▸",
    "bw.contact.b.tag": "By invitation",
    "bw.contact.b.title": "Custom Development",
    "bw.contact.b.desc":
      "Selective, so no calendar yet. Email me the project first — what it is, why it's interesting. If it fits, we'll talk.",
    ...
    "bw.cta.sub":
      "Start with a free scan, or just tell me the problem. I'll ship the agent and harden it.",
    ...
    "bw.blog.sub":
      "Notes on AI agents, AI security and the machines learning to move without us — recorded raw, published before the trace resolves.",
    "bw.blog.ctaTitle": 'Got a hard<br><span class="rip">AI problem?</span>',
    "bw.blog.ctaSub":
      "Whether it's building agents or breaking them — if it's interesting, I want to hear about it.",
    "bw.blog.ctaBtn": "START A PROJECT ▸",
    "bw.404.kicker": "// SIGNAL LOST",
    "bw.404.title": "This page went dark.",
    "bw.404.body":
      "The trace didn't resolve — the page you're after doesn't exist, moved, or was never here. Let's get you back to something real.",
  ...
  zh: {
    ...
    "hero.subtitle":
      "专注于 AI 智能体与 AI 安全。我把复杂问题转化为优雅、安全的技术方案。快速迭代、现代技术、可衡量的成果。",
    "hero.cta": "启动项目",
    "hero.cta2": "查看服务",
    "hero.techStack": "技术栈",
    ...
    "services.ai.description":
      "从自主智能体到自动化工作流，再到自托管 LLM。定制化 AI 系统，完全掌控数据主权——您的 AI、您的基础设施、您的掌控。",
    "services.security.title": "AI 安全",
    "services.security.description":
      "面向 AI 系统与现代 Web 基础设施的安全审计与加固。从提示注入防护到云安全——让您的 AI 方案不致沦为攻击面。（提示注入挑战赛第 2 名。）",
    "services.custom.badge": "✦ 仅限精选项目",
    "services.custom.title": "定制开发",
    "services.custom.description":
      "全栈 Web 与移动开发我如今只选择性承接——面向格外契合的项目。",
    "about.kicker": "我是谁",
    "about.title": "愿景与驱动力",
    "about.description1":
      "作为您的 IT 顾问，我的职责不仅是交付技术方案，更是为即将到来的未来铺路。我的工作由一个愿景驱动：通过 AI 与创新应用创造新的可能。",
    "about.description2":
      "透明、伙伴式协作，以及对品质毫不动摇的追求，是我工作的基石——以共同成就非凡。",
    "about.description3":
      "在 AI 时代，速度至关重要：快速迭代、快速验证、真实成果。正确运用新技术者，能在数周内完成过去需要数月的事。",
    "about.cta": "一起合作",
    "about.terminal.title": "关于我",
    "about.terminal.p1":
      "作为 IT 顾问与开发者，我将深厚的技术功底与创造创新方案的愿景结合在一起。",
    ...
    "contact.title": "让我们聊聊",
    "contact.description":
      "准备好讨论您的下一个项目了吗？期待收到您的消息，一起探索创新之路。",
    "contact.location": "瑞士",
    "contact.cta": "发送邮件",
    "footer.rights": "版权所有。",
    "footer.status": "在线",
    ...
    "bw.hero.sub":
      "我打造能真正干活的自主 AI 智能体——并在攻击者之前把它们攻破。从想法到上线，只需数周。",
    "bw.hero.cta1": "免费扫描我的网站 ▸",
    "bw.hero.cta2": "预约通话",
    "bw.hero.proof":
      "受 <b>Coop</b>、<b>Charité BIH</b> 及 10+ 团队信赖 · 提示注入挑战赛 <b>第 2 名</b>",
    "bw.scan.kicker": "// 免费 · 智能体机会扫描",
    "bw.scan.title":
      '看看我会为<span class="rip">你</span>打造什么——只需 15 秒。',
    "bw.scan.sub":
      "输入你的公司网址。我的 AI 会读取你的网站，精准定位自主智能体最能为你的团队省时的环节。无需注册。",
    "bw.scan.placeholder": "your-company.com",
    "bw.scan.run": "开始扫描 ▸",
    "bw.scan.hint": "◆ 仅读取你的公开网站 · 无需注册 · 约需 20 秒",
    ...
    "bw.scan.final.cached": "· 缓存结果（近期已扫描）",
    "bw.scan.aria.scanning": "正在扫描 {domain}",
    "bw.svc.kicker": "// 我做什么",
    "bw.svc.title": "我发挥价值的三种方式。",
    "bw.svc.1.title": 'AI <span class="rip">智能体</span>',
    "bw.svc.1.desc":
      "能真正干活的自主智能体、工作流与自托管 LLM——完全的数据主权。Ollama、CrewAI、LangChain、RAG。",
    "bw.svc.1.cta": "预约通话 ▸",
    "bw.svc.2.title": 'AI <span class="rip">安全</span>',
    "bw.svc.2.desc":
      "面向 AI 系统的红队与加固——从提示注入防护到云端。提示注入挑战赛第 2 名。",
    "bw.svc.2.cta": "预约通话 ▸",
    "bw.svc.3.title": '定制<span class="rip">开发</span>',
    "bw.svc.3.gate": "受邀制",
    "bw.svc.3.desc":
      "选择性承接——面向技术上有趣且真正契合的项目。跟我说说，我们再看。React Native、SvelteKit、Supabase、TypeScript。",
    "bw.svc.3.cta": "介绍项目 →",
    "bw.stats.1": "客户合作",
    "bw.stats.2": "提示注入挑战赛",
    "bw.stats.3": "已发布实战笔记",
    ...
    "bw.breach.intro":
      "一个已加固的智能体，两条消息即被投毒——无需越狱。这正是我猎捕的失效模式。",
    ...
    "bw.blog.sub":
      "关于 AI 智能体、AI 安全，以及正在学会脱离我们而行动的机器——原始记录，在踪迹消散前发布。",
    ...
    "bw.404.title": "此页已熄灭。",
    "bw.404.body":
      "踪迹未能解析——你要找的页面不存在、已移动，或从未在此。让我们回到真实的东西。",
    "bw.404.home": "◄ 返回首页",
    "bw.404.blog": "阅读博客",
  },
};
...
function setLanguage(lang) {
  ...
  const slugMap = {
    deToEn: {
      ...
      "ambient-ai-die-naechste-ki-generation.html":
  ...
  function mapSlug(file, from, to) {
    ...
    const table =
      slugMap[from + "To" + to.charAt(0).toUpperCase() + to.slice(1)];
    return (table && table[file]) || file;
  }
  if (path.includes("/blog/")) {
    // Determine current tree
    let fromTree = "de";
    if (path.includes("/posts/en/") || path.includes("/blog/en/"))
      fromTree = "en";
    else if (path.includes("/posts/zh/") || path.includes("/blog/zh/"))
      fromTree = "zh";
    ...
    if (path.includes("/posts/")) {
      ...
      if (lang !== fromTree) {
        const fromSeg =
          fromTree === "de" ? "/blog/" : "/blog/" + fromTree + "/";
